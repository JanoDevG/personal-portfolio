  ...
  return (
    <section className="relative w-full overflow-hidden bg-primary">
      ...
      <VortexBackground
        ...
        containerClassName="relative w-full h-[100vh]"  // 🔥 CUBRE TODO EL ALTO DEL HERO + VORTEX
        className="
...
>
  ...
  >
    {t.buttons.contact}
        ...
        {/* COLUMNA DERECHA */}
        <div className="flex justify-center items-center min-h-[22rem] lg:min-h-[30rem]">
